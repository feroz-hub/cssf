...
/// <summary>
/// EF Core entity type configuration that maps the <see cref="ClientPostLogoutRedirectUris"/> entity
/// to the "HCL.CS.SF_ClientPostLogoutRedirectUris" table. Enforces a unique constraint on
/// (ClientId, PostLogoutRedirectUri) to prevent duplicate post-logout redirect URIs per client.
/// </summary>
public class ClientPostLogoutRedirectUrisMap
{
    /// <summary>
    /// Initializes the client post-logout redirect URIs mapping.
    /// </summary>
    /// <param name="entityBuilder">The entity type builder for <see cref="ClientPostLogoutRedirectUris"/>.</param>
    ...
    private void ClientPostLogoutRedirectUrisMapping(EntityTypeBuilder<ClientPostLogoutRedirectUris> entityBuilder)
    {
        ...
        {
            entityBuilder.ToTable("HCL.CS.SF_ClientPostLogoutRedirectUris");
