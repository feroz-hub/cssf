...
/// Implementations verify the token parameter, token_type_hint, and client authorization.
/// </summary>
public interface ITokenRevocationRequestValidator
{
    /// <summary>
    /// Validates a token revocation request from the authenticated client.
    /// </summary>
    ...
    /// <returns>A validated revocation request model.</returns>
