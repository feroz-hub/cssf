 ...
 *
 * Maps every API route path to its expected request fields.
 * Derived directly from the backend C# DTOs and Gateway route handlers.
 */

export type FieldType = "string" | "guid" | "number" | "boolean" | "date" | "enum" | "object" | "array";
...
const guidId = (name: string, description?: string): FieldSchema => ({
  name,
  type: "guid",
  required: true,
...
const pagingFields: FieldSchema[] = [
...
const userClaimFields: FieldSchema[] = [
...
const userSecurityQuestionFields: FieldSchema[] = [
  guidId("userId", "Target user ID"),
...
export const endpointSchemas: Record<string, EndpointSchema> = {
  // =========================================================================
  // USER
  // =========================================================================
  ...
  "/Security/Api/Notification/GetNotificationLogs": {
    ...
    fields: [
      ...
      { name: "status", type: "enum", enumValues: [
        "1 - Initiated", "2 - Delivered", "3 - Failed", "4 - Delayed",
        "5 - Relayed", "6 - Expanded", "7 - Queued", "8 - Sending",
        "9 - Sent", "10 - Undelivered", "11 - Receiving", "12 - Received",
        "13 - Accepted", "14 - Scheduled", "15 - Read", "16 - Partially",
