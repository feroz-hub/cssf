...
/// <summary>
/// SQL Server-specific DbContext used for running EF Core migrations against a SQL Server database.
/// SQL Server natively supports rowversion for optimistic concurrency, requiring no custom conversion.
/// </summary>
    ...
    IdentityDbContext<Users, Roles, Guid, UserClaims, UserRoles, UserLogins, RoleClaims, UserTokens>
{
    ...
    /// <summary>Initializes the context with SQL Server-specific options.</summary>
    ...
    /// <summary>
    /// Configures entity mappings with restrict-delete foreign keys for SQL Server.
    /// </summary>
