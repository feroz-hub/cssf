...
namespace HCLCSSFInstallerMVC.Infrastructure.Persistence.Migrations.Sql;

public partial class HCLCSSFSqlV1 : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(
            ...
            unique: true,
            filter: "[ClientId] IS NOT NULL AND [ClientSecret] IS NOT NULL");
