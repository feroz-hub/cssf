...
{
    public partial class ApiResourcePopup : Window, IPageViewModel
    {
        ...
        public ApiResourcesModel CreateApiResourceModel()
        {
            ApiResourcesModel apiResourceModel = new ApiResourcesModel
            {
                ...
                {
                    new ApiResourceClaimsModel() {Type = "Claim", CreatedBy = "Test" },
                },
                ApiScopes = new List<ApiScopesModel>()
                {
                    new ApiScopesModel()
                    {   Name="Scope",
                        Emphasize = false, Required = true,
                        CreatedBy = "Test",
                        ApiScopeClaims = new List<ApiScopeClaimsModel>()
                        {
                            new ApiScopeClaimsModel() {Type = "ScopeClaim - 1", CreatedBy = "Test" },
                        }
                    },
                },
            };
        ...
        public ApiScopesModel CreateApiScopeModel()
        {
            ApiScopesModel apiScopeModel = new ApiScopesModel
            {
                ...
                ApiScopeClaims = new List<ApiScopeClaimsModel>()
                        {
                            new ApiScopeClaimsModel() {Type = "ApiScopeClaim", CreatedBy = "Test" },
                        }
            };
